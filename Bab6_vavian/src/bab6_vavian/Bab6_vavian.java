...
//        System.out.println((input % 2)); if ((input % 2) == 0) {
//        JOptionPane.showMessageDialog(null, "Angka : "+ input + " " + "adalah bilangan GENAP", "Informasi",JOptionPane.INFORMATION_MESSAGE);
//        } else if ((input % 2) == 1) {JOptionPane.showMessageDialog(null, "Angka : "+ input + " "+ "adalah bilangan GANJIL", "Informasi",JOptionPane.INFORMATION_MESSAGE);
//    }
...
//        } else {JOptionPane.showMessageDialog(null, "Dewasa");
//    }
